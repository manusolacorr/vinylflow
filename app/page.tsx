...
export default async function HomePage({ searchParams }: PageProps) {
  ...
  return (
    <main style={{
      ...
      justifyContent: 'center', padding: '2rem', flexDirection: 'column', gap: '1rem',
    }}>
      <div style={{
        ...
        {errorMsg && (
          <div style={{
            background: '#fff5f5', border: '1px solid var(--red)', borderRadius: 7,
            padding: '0.6rem 0.8rem', marginBottom: '1rem', fontSize: '0.75rem', color: 'var(--red)',
          }}>
            ⚠ {errorMsg}
          </div>
        )}
        ...
        <p style={{ fontSize: '0.65rem', color: 'var(--muted)', marginTop: '0.8rem', textAlign: 'center' }}>
          You&apos;ll be redirected to Discogs to authorise access. We never see your password.
        </p>
      </div>

      <p style={{ fontSize: '0.6rem', color: 'var(--muted)', textAlign: 'center' }}>
        BPM data powered by{' '}
        <a href="https://getsongbpm.com" style={{ color: 'var(--muted)', textDecoration: 'underline' }}>
          GetSongBPM
        </a>
      </p>
    </main>
